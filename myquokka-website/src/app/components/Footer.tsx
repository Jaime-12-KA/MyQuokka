      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-neutral-2 text-sm mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/press" className="text-neutral-2 hover:text-white">보도자료</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/info-center" className="text-neutral-2 hover:text-white">정보 센터</Link></li>
              <li><Link href="/custom-services" className="text-neutral-2 hover:text-white">맞춤형 서비스</Link></li>
              <li><Link href="/community" className="text-neutral-2 hover:text-white">커뮤니티</Link></li>
              <li><Link href="/membership" className="text-neutral-2 hover:text-white">멤버십</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/help" className="text-neutral-2 hover:text-white">고객 지원</Link></li>
        ...
        <hr className="border-neutral-3 my-8" />
        
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-neutral-2">
            &copy; {currentYear} MyQuokka. 모든 권리 보유.
          </p>
          <div className="mt-4 md:mt-0">
            <select className="bg-neutral-3 text-white px-3 py-1 rounded-md text-sm">
